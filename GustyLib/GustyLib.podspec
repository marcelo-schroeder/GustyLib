#
#  Be sure to run `pod spec lint GustyLib.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Marcelo Schroeder"
  # s.authors            = { "Marcelo Schroeder" => "marcelo.schroeder@infoaccent.com" }
  # s.social_media_url   = "http://twitter.com/Marcelo Schroeder"
