...
@implementation UIBarButtonItem (IFACategory)
...
- (id)initWithImageName:(NSString *)a_imageName
    ...
    [self.ifa_button addTarget:self action:@selector(XYZ_onButtonAction) forControlEvents:UIControlEventTouchUpInside];
