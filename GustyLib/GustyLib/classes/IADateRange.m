...
- (NSDecimalNumber*)decimalHoursForCalendar:(NSCalendar*)a_calendar{
    return [IADateRange decimalHoursForStartDate:self.startTimestamp endDate:self.endTimestamp calendar:a_calendar];
}

- (NSString*)decimalHoursStringForCalendar:(NSCalendar*)a_calendar{
    return [IADateRange decimalHoursStringForStartDate:self.startTimestamp endDate:self.endTimestamp calendar:a_calendar];
}
...
//	NSLog(@"                   endDate: %@", [anEndDate descriptionWithLocale:[NSLocale currentLocale]]);
    ...
    if (aFormat==IA_DURATION_FORMAT_DECIMAL_HOURS) {
        ...
        return [IADateRange decimalHoursStringForStartDate:aStartDate endDate:anEndDate calendar:a_calendar];
