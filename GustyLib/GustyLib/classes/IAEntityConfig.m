...
- (NSString*)headerForForm:(NSString*)aFormName inObject:(NSObject*)anObject{
	return [[[[[self entityConfigDictionary] valueForKey:[anObject entityName]] valueForKey:@"forms"] valueForKey:aFormName] valueForKey:@"formHeader"];
}

- (NSString*)footerForForm:(NSString*)aFormName inObject:(NSObject*)anObject{
	return [[[[[self entityConfigDictionary] valueForKey:[anObject entityName]] valueForKey:@"forms"] valueForKey:aFormName] valueForKey:@"formFooter"];
}
...
- (NSArray*)dependentsForProperty:(NSString*)aPropertyName inObject:(NSObject*)anObject{
    return [[self.p_entityToDependencyParentChildrenDict valueForKey:[anObject entityName]] valueForKey:aPropertyName];
}
...
- (NSString*)parentPropertyForDependent:(NSString*)aPropertyName inObject:(NSObject*)anObject{
    return [[self.p_entityToDependencyChildParentDict valueForKey:[anObject entityName]] valueForKey:aPropertyName];
}
...
- (BOOL)isEnumerationForProperty:(NSString*)aPropertyName inObject:(NSObject*)anObject{
    return [self isEnumerationForProperty:aPropertyName inEntity:[anObject entityName]];
}
...
- (BOOL)shouldTriggerChangeNotificationForProperty:(NSString*)aPropertyName inManagedObject:(NSManagedObject*)aManagedObject{
    return [self shouldTriggerChangeNotificationForProperty:aPropertyName inEntity:[aManagedObject entityName]];
}
...
- (BOOL)shouldTriggerChangeNotificationForManagedObject:(NSManagedObject*)aManagedObject{
    return [self shouldTriggerChangeNotificationForEntity:[aManagedObject entityName]];
}
...
- (NSPropertyDescription*)descriptionForProperty:(NSString*)aPropertyName inObject:(NSObject*)anObject{
	return [self descriptionForProperty:aPropertyName inEntity:[anObject entityName]];
}
...
- (NSArray*)propertiesWithBackingPreferencesForObject:(NSObject*)anObject{
    ...
    NSDictionary *l_propertiesDict = [[[self entityConfigDictionary] valueForKey:[anObject entityName]] valueForKey:@"properties"];
    for (NSString *l_propertyName in [l_propertiesDict allKeys]) {
        NSDictionary *l_propertyDict = [l_propertiesDict valueForKey:l_propertyName];
...
- (NSString*)backingPreferencesPropertyForProperty:(NSString*)aPropertyName inObject:(NSObject*)anObject{
	return [[[[[self entityConfigDictionary] valueForKey:[anObject entityName]] valueForKey:@"properties"] valueForKey:aPropertyName] valueForKey:@"backingPreferencesProperty"];
}
