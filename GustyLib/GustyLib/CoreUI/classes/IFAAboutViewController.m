...
- (IBAction)bugReportButtonTap:(id)sender{
    ...
    [self.IFA_emailManager composeEmailWithSubject:NSLocalizedStringFromTable(@"Bug Report", @"GustyLibLocalizable", nil) recipient:[self IFA_bugReportEmailAddress] body:l_body];
}
...
- (IBAction)feedbackButtonTap:(id)sender{
    ...
    [self.IFA_emailManager composeEmailWithSubject:NSLocalizedStringFromTable(@"Feedback", @"GustyLibLocalizable", nil) recipient:[self IFA_feedbackEmailAddress] body:l_body];
}
...
- (IBAction)thirdPartyCreditsButtonTap:(id)sender {
    ...
    l_viewController.title = NSLocalizedStringFromTable(@"Third Party Credits", @"GustyLibLocalizable", nil);
