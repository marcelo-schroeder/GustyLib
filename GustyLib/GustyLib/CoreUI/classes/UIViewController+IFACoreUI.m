...
- (void)ifa_presentAlertControllerWithTitle:(NSString *)a_title
    ...
    UIAlertAction *continueAction = [UIAlertAction actionWithTitle:NSLocalizedStringFromTable(@"Continue", @"GustyLibLocalizable", nil)
...
- (void)ifa_presentAlertControllerWithTitle:(NSString *)a_title message:(NSString *)a_message
    ...
    UIAlertAction *cancelAction = [UIAlertAction actionWithTitle:NSLocalizedStringFromTable(@"Cancel", @"GustyLibLocalizable", nil)
