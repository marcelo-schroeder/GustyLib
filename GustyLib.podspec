Pod::Spec.new do |s|
    ...
    s.default_subspec   = 'HighLevelUI'
    s.subspec 'Foundation' do |ss|
        ss.source_files  = 'GustyLib/GustyLib/Foundation/classes/**/*.{h,m}'
        ss.resource      = 'GustyLib/GustyLib/Foundation/resources/**/*.*'
    end
    s.subspec 'HighLevelUI' do |ss|
        ss.source_files  = 'GustyLib/GustyLib/HighLevelUI/classes/**/*.{h,m}'
        ss.resource      = 'GustyLib/GustyLib/HighLevelUI/resources/**/*.*'
    ...
    s.subspec 'GoogleMobileAdsSupport' do |ss|
        ...
        ss.dependency 'GustyLib/HighLevelUI'
